...
public class Test02 {
    ...
    // 대소문자를 구분하는 key : 원래의 Map에서 사용하는 key는 대소문자를 구별한다.
    ...
    public static void test2() {
        ...
        map.put("Name".toLowerCase(), "호로록");
        map.put("naMe".toLowerCase(), "호야양");
