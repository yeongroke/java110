...
public class MyAdvice {
    ...
    // 다음과 같이 설정해야 한다.
    // <aop:before method="before" pointcut="execution(* ex11.step6.ServiceImpl.addPhoto(..)) and args(f)"/>
    ...
    // 다음과 같이 설정해야 한다.
    // <aop:after-returning method="afterReturning" pointcut="execution(* ex11.step6.ServiceImpl.addPhoto(..))"
    // returning="rt"/>
    ...
    // 다음과 같이 설정해야 한다.
    // <aop:after-throwing method="afterThrowing" pointcut="execution(* ex11.step6.ServiceImpl.addPhoto(..))"
    // throwing="err"/>
