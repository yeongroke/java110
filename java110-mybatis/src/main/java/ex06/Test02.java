...
public class Test02 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //    p1_memb 테이블에 대해 따로select를 하지 않는다.
        // => 게시물을 가져올 때 join 해서 한 번에 select하여 가져온다.
        // => 단 게시물에 작성자 정보도 담아야 하기 때문에
        //    Board 테이블에 email과 tel 필드를 추가해야 한다.
        // => 목록에서 간단히 name을 추가하는 경우와 달리 
        //    Board 클래스에 작성자의 대부분의 정보를 저장할 필드 또한 많이 추가해야 한다.
        // => 이것은 객체지향의 중요한 특징 중 하나인
        //    "High Cohesion(높은 응집력: 한 클래스에 한 역할)"을 어기는 것이다.
