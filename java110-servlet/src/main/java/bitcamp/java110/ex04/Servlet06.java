...
public class Servlet06 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        //    다음과 같이 connector 태그에 URLEncoding 속성을 추가하라
        ...
        // GET 요청에 대해서는 setCharacterEncoding()이 효력이 없다. post요청에만 이거씀
...
// => 웹브라우저와 웹서버 사이에 데이터를 주고받는 HTTP 프로토콜을 분석하다 보 면
//    %xx%xx%xx와 같은 데이터를 보게 된다.
