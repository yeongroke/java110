...
public class Servlet01 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // 테스트:
        // => http://localhost:8888/ex04/get.html 페이지에서 값을 입력후 보내기 버튼
...
// GET 요청
// => GET 요청으로 서버에 값을 보내기 위해서는 Request-URL에 포함해야 한다.
// => Request URL: http://localhost:8888/ex04/servlet01?name=%EA%B9%80%EC%98%81%EB%A1%9D&age=24&working=false
/*
GET /ex04/servlet01?name=%EA%B9%80%EC%98%81%EB%A1%9D&age=24&working=false HTTP/1.1
Host: localhost:8888
...
//   => 그래서 링크를 누르면 결과 화면으로 바로 확인할 수 있다.
...
// - 바이너리(Binary) 데이터 전송
//   => request-URL에 포함할 수 있는 것은 테스트이기 때문에
//      바이너리 데이터(이미지, 엑셀, 영상 등)를 전송하는데 적합하지 않다.
//   => 물론 Base64 인코딩(프로그램이름임)을 이용하여 바이너리 데이터를 텍스트 데이터로 변환한 다음에
//      보낼 수는 있다.
