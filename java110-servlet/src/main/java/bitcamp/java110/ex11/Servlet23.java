...
public class Servlet23 extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // => 10초 사이에 다시 요처잉 들어오지 않으면
        //    해당 세션은 무효화된다.
        //방법 1 방법2는 web.xml로 하는것
        //session.setMaxInactiveInterval(10); // 단위는 초(seconds).
        
        // 세션에 데이터 보관하기
        session.setAttribute("name", "이이이이이이이이이잉");
        
        // 테스트:
        // => 이 서블릿을 실행한 후 30초 이전에 /ex11/servlet22 실행하기
        // => 그리고 다시 30초 지난 후에 /ex11//servlet22 실행하기
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>세션 데이터 보관하기 - 타임아웃 설정</h1>");
        out.println("</body>");
        out.println("</html>");
    }
}
