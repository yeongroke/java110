...
public class Servlet21 extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 세션 얻기  // 세션을 주고받는 것은 쿠키이다.
        // => 요청 프로토콜의 쿠키 정보에서 세션아이디를 검색한다.
        // => 있다면,
        ...
        // => 톰캣 서버에서는 JSESSIONID라는 쿠키 이름으로 세션 아이들르 보낸다.
        // => WAS 마다 세션ID의 쿠키이름이 다를 수 있다.
        /*
HTTP/1.1 200
Set-Cookie: JSESSIONID=~~~~블라블라; Path=/;   <==주소를 나타냄
Content-Type: text/html;charset=UTF-8
Content-Length: 143
Date: Tue, 02 Oct 2018 00:51:32 GMT

         * */
        HttpSession session = request.getSession();
        
        // 세션에 데이터 보관하기
        session.setAttribute("name", "호오홍홍홍");
