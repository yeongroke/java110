...
public class Servlet01_2 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        // => 웹 애플리케이션 전체 범위로 확장
        //    "이 쿠키는 전체 서블릿(/**)에 대해 무조건 보내달라는 뜻임"
        //    라고 웹브라우저에게 지시하는 것이다.
        Cookie c2 =new Cookie("age", "12");// 그냥 12을 적으면 안됨 "12"이렇게 해야한다.
        c2.setPath("/");
...
Set-Cookie: age=12; Path=/    <== 응답 경로가 추가됨
Set-Cookie: working=true; Path=/ex10/a/b    <== 응답 경로가 추가됨
Content-Type: text/html;charset=UTF-8
Content-Length: 140
Date: Mon, 01 Oct 2018 02:49:40 GMT
        */
