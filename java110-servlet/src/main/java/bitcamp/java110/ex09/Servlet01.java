...
public class Servlet01 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        String op = req.getParameter("op"); // autoboxing임 
        ...
        if(!op.equals("+")) {
            ...
            // 작업을 위침 받은 서블릿이 데이터를 바로 사용할 수 있도록
            // ServletRequest 보관소에 저장한다.
            req.setAttribute("op", op); 
            // => autoboxing이 되어서 이렇게 객체가 아닌데도 불구하고 쓸수잇음 
            req.setAttribute("a", a);
            req.setAttribute("b", b);
            
            /*int v1 = 100;
            Integer v2 = Integer.valueOf(a);
            Integer v3 = v1;
            
            Integer v4 = Integer.valueOf(200);
            int v5 = v4; // auto-unboxing
            int v6 = v4.intValue(); */
...
//    즉 '%2B'를 보내야 한다.
// => 따라서 + 연산을 이 서블릿에 보내려면
//    http://localhost:8888/ex09/servlet01?a=100&b=80&op=%2b 이렇게 해야함
