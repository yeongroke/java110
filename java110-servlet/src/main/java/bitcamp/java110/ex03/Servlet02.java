...
public class Servlet02 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // 출력스크림을 꺼내기 전에 지정해야 한다. 즉, printwriter을 쓰기 전에 선언해주어야 함 
        res.setContentType("text/plain;charset=UTF-8");
        // => 서블릿 컨테이너는 
        //    이 설정에 따라 출력할 수 있는 출력 스트림 객체를 리턴한다.
        ...
        //    조합형                          - 16비트. 아래아한글 규칙. 
        //                    초성(5), 중성(5), 종성(5)로 표현.
        //                    3만자 이상의 모든 한글 문자를 표기할 수 있다. 한글은 이거 안씀
        //    MS949(CP949)  - 16비트. MS OS의 코드표. EUC-KR(2350) + 8822 = 11172자
        //    MS949는 국제표준이 아니라서 쓰면안됨 이걸 대신해 등장한게 Unicode임
        //    Unicode       - 16비트. 국제 표준이다. 한글은 11172자가 정의되어 있다.
        //                    영어도 2바이트로 표현된다. 이 영어가 2바이트를 출력되는 걸 보완해서 나온게 UTF-8임
        //    UTF-8         - 1~4바이트로 문자 표현. 국제 표준이다.
        //                    유니코드의 변형이다. 한글은 규칙에 따라 3바이트로 표현한다.
        //                    영어는 ISO-8859-1 코드 그대로 1바이트로 표현한다.
        //                    유니코드에 없는거는 UTF-8로 변형 못한다.
        //
    }
}